export const products = [
    ...
    {
        id: 'w_wed_1',
        name: 'Embroidered Anarkali Suit (Maroon)',
        price: '₹3,499',
        store: 'Myntra',
    ...
    {
        id: 'm_off_1',
        name: 'Slim Fit Cotton Shirt (Blue)',
        price: '₹1,199',
        store: 'Amazon',
