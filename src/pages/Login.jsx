        ...
        <div className="min-h-screen flex items-center justify-center px-4 pt-20">
            ...
            >
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                    ...
                    <div className="relative my-6">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="px-2 bg-[#1a1638]/0 text-purple-200">Or continue with</span>
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        onClick={async () => {
                            try {
                                ...
                                // Create/Update Firestore User for Google Sign-In
                                const { doc, setDoc, getFirestore, getDoc } = await import('firebase/firestore');
                        ...
                        disabled={loading}
                        className="w-full bg-white text-gray-900 py-3 rounded-xl font-bold shadow-lg hover:shadow-white/20 transform hover:-translate-y-1 transition-all flex items-center justify-center gap-2"
                    >
                ...
                <div className="mt-6 text-center text-purple-200">
                    Need an account? <Link to="/signup" className="text-white font-bold hover:underline">Sign Up</Link>
                </div>
            </motion.div>
        </div>
    );
